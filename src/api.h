...
#define MYMPD_CMDS(X) \
    ...
    X(MPD_API_QUEUE_ADD_PLAY_TRACK_AFTER) \
    ...
    X(MYMPD_API_TIDAL_SEARCH_TO_QUEUE) \
    X(MPD_API_QUEUE_ADD_ALL_TRACKS) \
    X(MPD_API_PLAYLIST_ADD_ALL_TRACKS)
    /* X(MPD_API_QUEUE_ADD_TIDAL_TRACK) \
    X(MYMPD_API_QOBUZ_SEARCH) \
    X(MYMPD_API_QOBUZ_SONGDETAILS) \
    X(MYMPD_API_QOBUZ_ALBUMDETAILS) \
    X(MYMPD_API_QOBUZ_ARTISTDETAILS) \
    X(TIDAL_API_SEARCH) \
    X(TIDAL_API_SONGDETAILS) \
    X(TIDAL_API_ALBUMDETAILS) \
    X(TIDAL_API_ARTISTDETAILS) */
