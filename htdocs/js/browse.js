...
function initBrowse() {
    document.getElementById('BrowseDatabaseListList').addEventListener('click', function (event) {
        if (app.current.tag === 'Album') {
            if (event.target.classList.contains('card-body')) {
                appGoto(app.current.app, 'Database', 'Detail', 0, undefined, 'Album', 'AlbumArtist',
    ...
    document.getElementById('BrowseDatabaseSwapList').addEventListener('click', function (event) {
