...
t("Empty list")+"</div>")}document.getElementById("dropdownServers").children[0].innerHTML=b}function checkUpdate(){sendAPI("MYMPD_API_UPDATE_CHECK",{},parseUpdateCheck);btnWaiting(document.getElementById("btnCheckUpdate"),!0)}
...
function(d){d.preventDefault();"A"===d.target.nodeName&&(d=d.target.getAttribute("data-value").match(/^(\w+:\/\/)(.+)$/),document.getElementById("selectMountUrlhandler").value=d[1],document.getElementById("inputMountUrl").value=d[2])});document.getElementById("btnDropdownServers").parentNode.addEventListener("show.bs.dropdown",function(){sendAPI("MYMPD_API_NS_SERVER_LIST",{},parseServers,!0)});document.getElementById("dropdownServers").children[0].addEventListener("click",function(d){d.preventDefault();
"A"===d.target.nodeName&&(document.getElementById("inputNsServer").value=d.target.getAttribute("data-value"))});document.getElementById("BrowseFilesystemBookmark").parentNode.addEventListener("show.bs.dropdown",function(){sendAPI("MYMPD_API_BOOKMARK_LIST",{offset:0},parseBookmarks)});document.getElementById("playDropdown").parentNode.addEventListener("show.bs.dropdown",function(){showPlayDropdown()});document.getElementById("playDropdown").addEventListener("click",function(d){d.preventDefault();d.stopPropagation()});
a=document.querySelectorAll(".dropdown-toggle");for(b=0;b<a.length;b++)a[b].parentNode.addEventListener("show.bs.dropdown",function(){alignDropdown(this)});document.getElementById("modalTimer").addEventListener("shown.bs.modal",function(){showListTimer()});document.getElementById("modalMounts").addEventListener("shown.bs.modal",function(){showListMounts()});document.getElementById("modalScripts").addEventListener("shown.bs.modal",function(){showListScripts()});document.getElementById("modalTrigger").addEventListener("shown.bs.modal",
function(){showListTrigger()});document.getElementById("modalPartitions").addEventListener("shown.bs.modal",function(){showListPartitions()});document.getElementById("modalPartitionOutputs").addEventListener("shown.bs.modal",function(){sendAPI("MPD_API_PLAYER_OUTPUT_LIST",{partition:"default"},parsePartitionOutputsList,!1)});document.getElementById("modalAbout").addEventListener("shown.bs.modal",function(){sendAPI("MPD_API_DATABASE_STATS",{},parseStats);getServerinfo();var d="",g;for(g in keymap)if(void 0===
keymap[g].req||!0===settings[keymap[g].req])d+='<tr><td><div class="key'+(keymap[g].key&&1<keymap[g].key.length?" material-icons material-icons-small":"")+'">'+(void 0!==keymap[g].key?keymap[g].key:g)+"</div></td><td>"+t(keymap[g].desc)+"</td></tr>";document.getElementById("tbodyShortcuts").innerHTML=d});document.getElementById("modalAddToPlaylist").addEventListener("shown.bs.modal",function(){document.getElementById("addStreamFrm").classList.contains("hide")?document.getElementById("addToPlaylistPlaylist").focus():
...
!1);document.getElementById("selectTimerAction").addEventListener("change",function(){selectTimerActionChange()},!1);document.getElementById("selectTriggerScript").addEventListener("change",function(){selectTriggerActionChange()},!1);a="";for(b=0;24>b;b++)a+='<option value="'+b+'">'+zeroPad(b,2)+"</option>";document.getElementById("selectTimerHour").innerHTML=a;a="";for(b=0;60>b;b+=5)a+='<option value="'+b+'">'+zeroPad(b,2)+"</option>";document.getElementById("selectTimerMinute").innerHTML=a;document.getElementById("inputHighlightColor").addEventListener("change",
function(){document.getElementById("highlightColorPreview").style.backgroundColor=this.value},!1);document.getElementById("inputBgColor").addEventListener("change",function(){document.getElementById("bgColorPreview").style.backgroundColor=this.value},!1);document.getElementById("selectTheme").addEventListener("change",function(){var d=getSelectValue(this);"theme-default"===d?document.getElementById("inputBgColor").value="#ccc":"theme-light"===d?document.getElementById("inputBgColor").value="#fff":
"theme-dark"===d?document.getElementById("inputBgColor").value="#000":"theme-maroon"===d&&(document.getElementById("inputBgColor").value="#800");document.getElementById("bgColorPreview").style.backgroundColor=document.getElementById("inputBgColor").value},!1);document.getElementById("modalAddToQueue").addEventListener("shown.bs.modal",function(){document.getElementById("inputAddToQueueQuantity").classList.remove("is-invalid");document.getElementById("warnJukeboxPlaylist2").classList.add("hide");!0===
settings.featPlaylists&&sendAPI("MPD_API_PLAYLIST_LIST_ALL",{searchstr:""},function(d){getAllPlaylists(d,"selectAddToQueuePlaylist")})});document.getElementById("modalUpdateDB").addEventListener("hidden.bs.modal",function(){document.getElementById("updateDBprogress").classList.remove("updateDBprogressAnimate")});document.getElementById("modalSaveQueue").addEventListener("shown.bs.modal",function(){var d=document.getElementById("saveQueueName");d.focus();d.value="";d.classList.remove("is-invalid")});
...
document.getElementById("nsCredentials").classList.remove("hide")):(document.getElementById("nsServerShare").classList.remove("hide"),"1"===d?document.getElementById("sambaVersion").classList.remove("hide"):document.getElementById("sambaVersion").classList.add("hide"),document.getElementById("nsCredentials").classList.add("hide"),document.getElementById("inputNsUsername").value="",document.getElementById("inputNsPassword").value="")});document.getElementById("modalConnection").addEventListener("shown.bs.modal",
function(){getSettings();document.getElementById("inputMpdHost").classList.remove("is-invalid");document.getElementById("inputMpdPort").classList.remove("is-invalid");document.getElementById("inputMpdPass").classList.remove("is-invalid")});document.getElementById("btnJukeboxModeGroup").addEventListener("mouseup",function(){setTimeout(function(){var d=document.getElementById("btnJukeboxModeGroup").getElementsByClassName("active")[0].getAttribute("data-value");"0"===d?(document.getElementById("inputJukeboxQueueLength").setAttribute("disabled",
"disabled"),document.getElementById("selectJukeboxPlaylist").setAttribute("disabled","disabled")):"2"===d?(document.getElementById("inputJukeboxQueueLength").setAttribute("disabled","disabled"),document.getElementById("selectJukeboxPlaylist").setAttribute("disabled","disabled"),document.getElementById("selectJukeboxPlaylist").value="Database"):"1"===d&&(document.getElementById("inputJukeboxQueueLength").removeAttribute("disabled"),document.getElementById("selectJukeboxPlaylist").removeAttribute("disabled"));
...
(document.getElementById("warnPlaybackStatistics").classList.remove("hide"),document.getElementById("inputJukeboxLastPlayed").setAttribute("disabled","disabled"))},100)});document.getElementById("selectAddToQueueMode").addEventListener("change",function(){var d=this.options[this.selectedIndex].value;"2"===d?(document.getElementById("inputAddToQueueQuantity").setAttribute("disabled","disabled"),document.getElementById("inputAddToQueueQuantity").value="1",document.getElementById("selectAddToQueuePlaylist").setAttribute("disabled",
"disabled"),document.getElementById("selectAddToQueuePlaylist").value="Database"):"1"===d&&(document.getElementById("inputAddToQueueQuantity").removeAttribute("disabled"),document.getElementById("selectAddToQueuePlaylist").removeAttribute("disabled"))});document.getElementById("addToPlaylistPlaylist").addEventListener("change",function(){"new"===this.options[this.selectedIndex].value?(document.getElementById("addToPlaylistNewPlaylistDiv").classList.remove("hide"),document.getElementById("addToPlaylistNewPlaylist").focus()):
...
"readonly")):(document.getElementById("inputMusicDirectory").value="",document.getElementById("inputMusicDirectory").removeAttribute("readonly"))},!1);document.getElementById("syscmds").addEventListener("click",function(d){"A"===d.target.nodeName&&parseCmd(d,d.target.getAttribute("data-href"))},!1);document.getElementById("scripts").addEventListener("click",function(d){"A"===d.target.nodeName&&execScript(d.target.getAttribute("data-href"))},!1);a=document.querySelectorAll("[data-href]");b=a.length;
for(c=0;c<b;c++){!1===a[c].classList.contains("notclickable")&&a[c].classList.add("clickable");var f=a[c].parentNode.classList.contains("noInitChilds")?!0:!1;!1===f&&(f=a[c].parentNode.parentNode.classList.contains("noInitChilds")?!0:!1);!0!==f&&a[c].addEventListener("click",function(d){parseCmd(d,this.getAttribute("data-href"))},!1)}document.getElementById("HomeCards").addEventListener("click",function(d){if(d.target.classList.contains("card-body")){var g=d.target.parentNode.getAttribute("data-href");
null!==g&&parseCmd(d,g)}else if(d.target.classList.contains("card-footer")){g=document.getElementById("HomeCards").getElementsByClassName("selected");for(var k=0;k<g.length;k++)g[k].classList.remove("selected");d.target.parentNode.classList.add("selected");showMenu(d.target,d);d.stopPropagation()}},!1);document.getElementById("HomeCards").addEventListener("keydown",function(d){navigateGrid(d.target,d.key)},!1);dragAndDropHome();document.getElementById("selectHomeIconCmd").addEventListener("change",
function(){showHomeIconCmdOptions()},!1);document.getElementById("inputHomeIconLigature").addEventListener("change",function(d){document.getElementById("homeIconPreview").innerText=d.target.value;""!==d.target.value&&(document.getElementById("selectHomeIconImage").value="",document.getElementById("homeIconPreview").style.backgroundImage="")},!1);document.getElementById("inputHomeIconBgcolor").addEventListener("change",function(d){document.getElementById("homeIconPreview").style.backgroundColor=d.target.value},
!1);document.getElementById("selectHomeIconImage").addEventListener("change",function(d){d=getSelectValue(d.target);document.getElementById("homeIconPreview").style.backgroundImage='url("'+subdir+"/browse/pics/"+d+'")';""!==d?(document.getElementById("divHomeIconLigature").classList.add("hide"),document.getElementById("homeIconPreview").innerHTML=""):(document.getElementById("divHomeIconLigature").classList.remove("hide"),document.getElementById("homeIconPreview").innerText=document.getElementById("inputHomeIconLigature").value)},
!1);a=document.getElementsByClassName("pages");b=a.length;for(c=0;c<b;c++)a[c].addEventListener("click",function(d){"BUTTON"===d.target.nodeName&&gotoPage(d.target.getAttribute("data-page"))},!1);document.getElementById("cardPlaybackTags").addEventListener("click",function(d){"SPAN"===d.target.nodeName&&gotoBrowse()},!1);document.getElementById("BrowseBreadcrumb").addEventListener("click",function(d){"A"===d.target.nodeName&&(d.preventDefault(),appGoto("Browse","Filesystem",void 0,"0",app.current.filter,
app.current.sort,"-",decodeURI(d.target.getAttribute("data-uri"))))},!1);document.getElementById("tbodySongDetails").addEventListener("click",function(d){if("A"===d.target.nodeName)if("calcFingerprint"===d.target.id){sendAPI("MPD_API_DATABASE_FINGERPRINT",{uri:decodeURI(d.target.getAttribute("data-uri"))},parseFingerprint);d.preventDefault();var g=d.target.parentNode,k=document.createElement("div");k.classList.add("spinner-border","spinner-border-sm");d.target.classList.add("hide");g.appendChild(k)}else null!==
d.target.parentNode.getAttribute("data-tag")&&(modalSongDetails.hide(),d.preventDefault(),gotoBrowse());else"BUTTON"===d.target.nodeName&&d.target.getAttribute("data-href")&&parseCmd(d,d.target.getAttribute("data-href"))},!1);document.getElementById("outputs").addEventListener("click",function(d){"BUTTON"===d.target.nodeName?(d.stopPropagation(),d.preventDefault(),sendAPI("MPD_API_PLAYER_TOGGLE_OUTPUT",{output:d.target.getAttribute("data-output-id"),state:d.target.classList.contains("active")?0:1}),
toggleBtn(d.target.id)):"A"===d.target.nodeName&&(d.preventDefault(),showListOutputAttributes(decodeURI(d.target.parentNode.getAttribute("data-output-name"))))},!1);document.getElementById("listTimerList").addEventListener("click",function(d){d.stopPropagation();d.preventDefault();"TD"===d.target.nodeName?d.target.parentNode.classList.contains("not-clickable")||showEditTimer(d.target.parentNode.getAttribute("data-id")):"A"===d.target.nodeName?deleteTimer(d.target.parentNode.parentNode.getAttribute("data-id")):
"BUTTON"===d.target.nodeName&&toggleTimer(d.target,d.target.parentNode.parentNode.getAttribute("data-id"))},!1);document.getElementById("listMountsList").addEventListener("click",function(d){d.stopPropagation();d.preventDefault();if("TD"===d.target.nodeName){if(""===d.target.parentNode.getAttribute("data-point"))return!1;showEditMount(decodeURI(d.target.parentNode.getAttribute("data-url")),decodeURI(d.target.parentNode.getAttribute("data-point")))}else if("A"===d.target.nodeName){var g=d.target.getAttribute("data-action"),
k=decodeURI(d.target.parentNode.parentNode.getAttribute("data-point"));"unmount"===g?unmountMount(k):"update"===g&&updateMount(d.target,k)}},!1);document.getElementById("listScriptsList").addEventListener("click",function(d){d.stopPropagation();d.preventDefault();if("TD"===d.target.nodeName){if(!1===settings.featScripteditor||""===d.target.parentNode.getAttribute("data-script"))return!1;showEditScript(decodeURI(d.target.parentNode.getAttribute("data-script")))}else if("A"===d.target.nodeName){var g=
d.target.getAttribute("data-action"),k=decodeURI(d.target.parentNode.parentNode.getAttribute("data-script"));"delete"===g?deleteScript(k):"execute"===g?execScript(d.target.getAttribute("data-href")):"add2home"===g&&addScriptToHome(k,d.target.getAttribute("data-href"))}},!1);document.getElementById("listTriggerList").addEventListener("click",function(d){d.stopPropagation();d.preventDefault();if("TD"===d.target.nodeName){var g=decodeURI(d.target.parentNode.getAttribute("data-trigger-id"));showEditTrigger(g)}else"A"===
d.target.nodeName&&(g=d.target.getAttribute("data-action"),d=decodeURI(d.target.parentNode.parentNode.getAttribute("data-trigger-id")),"delete"===g&&deleteTrigger(d))},!1);document.getElementById("listPartitionsList").addEventListener("click",function(d){d.stopPropagation();d.preventDefault();if("A"===d.target.nodeName){var g=d.target.getAttribute("data-action");d=decodeURI(d.target.parentNode.parentNode.getAttribute("data-partition"));"delete"===g?deletePartition(d):"switch"===g&&switchPartition(d)}},
!1);document.getElementById("partitionOutputsList").addEventListener("click",function(d){d.stopPropagation();d.preventDefault();"TD"===d.target.nodeName&&(d=decodeURI(d.target.parentNode.getAttribute("data-output")),moveOutput(d),modalPartitionOutputs.hide())},!1);document.getElementById("QueueCurrentList").addEventListener("click",function(d){"TD"===d.target.nodeName?sendAPI("MPD_API_PLAYER_PLAY_TRACK",{track:d.target.parentNode.getAttribute("data-trackid")}):"A"===d.target.nodeName&&showMenu(d.target,
d)},!1);document.getElementById("QueueLastPlayedList").addEventListener("click",function(d){"TD"===d.target.nodeName?appendPlayQueue("song",decodeURI(d.target.parentNode.getAttribute("data-uri")),d.target.parentNode.getAttribute("data-name")):"A"===d.target.nodeName&&showMenu(d.target,d)},!1);document.getElementById("QueueJukeboxList").addEventListener("click",function(d){"A"===d.target.nodeName&&showMenu(d.target,d)},!1);document.getElementById("QueueMiniList").addEventListener("click",function(d){"TD"===
d.target.nodeName&&sendAPI("MPD_API_PLAYER_PLAY_TRACK",{track:d.target.parentNode.getAttribute("data-trackid")})},!1);document.getElementById("BrowseFilesystemList").addEventListener("click",function(d){if("TD"===d.target.nodeName)switch(d.target.parentNode.getAttribute("data-type")){case "parentDir":case "dir":appGoto("Browse","Filesystem",void 0,"0",app.current.filter,app.current.sort,"-",decodeURI(d.target.parentNode.getAttribute("data-uri")));break;case "song":appendPlayQueue("song",decodeURI(d.target.parentNode.getAttribute("data-uri")),
d.target.parentNode.getAttribute("data-name"));break;case "plist":case "smartpls":playlistDetails(decodeURI(d.target.parentNode.getAttribute("data-uri")))}else"A"===d.target.nodeName&&showMenu(d.target,d)},!1);document.getElementById("BrowseFilesystemBookmarks").addEventListener("click",function(d){if("A"===d.target.nodeName){var g=d.target.parentNode.parentNode.getAttribute("data-id"),k=d.target.parentNode.parentNode.getAttribute("data-type"),l=decodeURI(d.target.parentNode.parentNode.getAttribute("data-uri")),
m=d.target.parentNode.parentNode.firstChild.innerText,n=d.target.getAttribute("data-href");"delete"===n?(sendAPI("MYMPD_API_BOOKMARK_RM",{id:g},function(){sendAPI("MYMPD_API_BOOKMARK_LIST",{offset:0},parseBookmarks)}),d.preventDefault(),d.stopPropagation()):"edit"===n?showBookmarkSave(g,m,l,k):"goto"===n&&appGoto("Browse","Filesystem",void 0,"0","-","-","-",l)}},!1);document.getElementById("BrowsePlaylistsAllList").addEventListener("click",function(d){"TD"===d.target.nodeName?playlistDetails(decodeURI(d.target.parentNode.getAttribute("data-uri"))):
"A"===d.target.nodeName&&showMenu(d.target,d)},!1);document.getElementById("BrowsePlaylistsDetailList").addEventListener("click",function(d){"TD"===d.target.nodeName?appendPlayQueue("song",decodeURI(d.target.parentNode.getAttribute("data-uri")),d.target.parentNode.getAttribute("data-name")):"A"===d.target.nodeName&&showMenu(d.target,d)},!1);document.getElementById("SearchList").addEventListener("click",function(d){"TD"===d.target.nodeName?appendPlayQueue("song",decodeURI(d.target.parentNode.getAttribute("data-uri")),
d.target.parentNode.getAttribute("data-name")):"A"===d.target.nodeName&&showMenu(d.target,d)},!1);document.getElementById("BrowseDatabaseCards").addEventListener("click",function(d){"Album"===app.current.tag?d.target.classList.contains("card-body")?appGoto(app.current.app,"Database","Detail","0","Album","AlbumArtist",decodeURI(d.target.parentNode.getAttribute("data-album")),decodeURI(d.target.parentNode.getAttribute("data-albumartist"))):d.target.classList.contains("card-footer")&&showMenu(d.target,
d):(app.current.search="",document.getElementById("searchDatabaseStr").value="",appGoto(app.current.app,app.current.card,void 0,"0","Album","AlbumArtist","Album","("+app.current.tag+" == '"+decodeURI(d.target.parentNode.getAttribute("data-tag"))+"')"))},!1);document.getElementById("BrowseDatabaseAlbumList").addEventListener("click",function(d){"TD"===d.target.nodeName?appGoto(app.current.app,"Database","Detail","0","Album","AlbumArtist",decodeURI(d.target.parentNode.getAttribute("data-album")),decodeURI(d.target.parentNode.getAttribute("data-albumartist"))):
"A"===d.target.nodeName&&showMenu(d.target,d)},!1);document.getElementById("BrowseDatabaseCards").addEventListener("keydown",function(d){navigateGrid(d.target,d.key)},!1);!1===isMobile&&(document.getElementById("BrowseDatabaseCards").addEventListener("mouseover",function(d){if(d.target.classList.contains("card-body")&&0===d.target.childNodes.length){var g=document.getElementById("BrowseDatabaseCards").getElementsByClassName("album-grid-mouseover");if(1<g.length)for(var k=0;k<g.length;k++)g[k].remove();
addPlayButton(d.target)}},!1),document.getElementById("BrowseDatabaseCards").addEventListener("mouseout",function(d){!d.target.classList.contains("card-body")||null!==d.relatedTarget&&d.relatedTarget.classList.contains("album-grid-mouseover")||(d.target.innerHTML="")},!1));document.getElementById("BrowseDatabaseDetailList").addEventListener("click",function(d){"TD"===d.target.nodeName?appendPlayQueue("song",decodeURI(d.target.parentNode.getAttribute("data-uri")),d.target.parentNode.getAttribute("data-name")):
"A"===d.target.nodeName&&showMenu(d.target,d)},!1);document.getElementById("BrowseFilesystemAddAllSongsDropdown").addEventListener("click",function(d){"BUTTON"===d.target.nodeName&&("Add all to queue"===d.target.getAttribute("data-phrase")?addAllFromBrowseFilesystem():"Add all to playlist"===d.target.getAttribute("data-phrase")&&showAddToPlaylist(app.current.search,""))},!1);document.getElementById("searchAddAllSongsDropdown").addEventListener("click",function(d){"BUTTON"===d.target.nodeName&&("Add all to queue"===
d.target.getAttribute("data-phrase")?addAllFromSearchPlist("queue",null,!1):"Add all to playlist"===d.target.getAttribute("data-phrase")?showAddToPlaylist("SEARCH",""):"Save as smart playlist"===d.target.getAttribute("data-phrase")&&saveSearchAsSmartPlaylist())},!1);document.getElementById("searchtags").addEventListener("click",function(d){"BUTTON"===d.target.nodeName&&(app.current.filter=d.target.getAttribute("data-tag"),doSearch(domCache.searchstr.value))},!1);document.getElementById("searchDatabaseTags").addEventListener("click",
function(d){"BUTTON"===d.target.nodeName&&(app.current.filter=d.target.getAttribute("data-tag"),appGoto(app.current.app,app.current.tab,app.current.view,"0",app.current.filter,app.current.sort,app.current.tag,app.current.search))},!1);document.getElementById("databaseSortDesc").addEventListener("click",function(d){toggleBtnChk(this);d.stopPropagation();d.preventDefault();"-"===app.current.sort.charAt(0)?app.current.sort=app.current.sort.substr(1):app.current.sort="-"+app.current.sort;appGoto(app.current.app,
app.current.tab,app.current.view,"0",app.current.filter,app.current.sort,app.current.tag,app.current.search)},!1);document.getElementById("databaseSortTags").addEventListener("click",function(d){"BUTTON"===d.target.nodeName&&(d.preventDefault(),d.stopPropagation(),app.current.sort=d.target.getAttribute("data-tag"),appGoto(app.current.app,app.current.tab,app.current.view,"0",app.current.filter,app.current.sort,app.current.tag,app.current.search))},!1);document.getElementById("BrowseDatabaseByTagDropdown").addEventListener("click",
function(d){navBrowseHandler(d)},!1);document.getElementById("BrowseNavPlaylistsDropdown").addEventListener("click",function(d){navBrowseHandler(d)},!1);document.getElementById("BrowseNavFilesystemDropdown").addEventListener("click",function(d){navBrowseHandler(d)},!1);document.getElementById("dropdownSortPlaylistTags").addEventListener("click",function(d){"BUTTON"===d.target.nodeName&&(d.preventDefault(),playlistSort(d.target.getAttribute("data-tag")))},!1);document.getElementById("searchqueuestr").addEventListener("keyup",
function(d){"Escape"===d.key?this.blur():appGoto(app.current.app,app.current.tab,app.current.view,"0",app.current.filter,app.current.sort,"-",this.value)},!1);document.getElementById("searchqueuetags").addEventListener("click",function(d){"BUTTON"===d.target.nodeName&&appGoto(app.current.app,app.current.tab,app.current.view,app.current.page,d.target.getAttribute("data-tag"),app.current.sort,"-",app.current.search)},!1);document.getElementById("searchFilesystemStr").addEventListener("keyup",function(d){"Escape"===
d.key?this.blur():appGoto(app.current.app,app.current.tab,app.current.view,"0",""!==this.value?this.value:"-",app.current.sort,"-",app.current.search)},!1);document.getElementById("searchPlaylistsStr").addEventListener("keyup",function(d){"Escape"===d.key?this.blur():appGoto(app.current.app,app.current.tab,app.current.view,"0",app.current.filter,app.current.sort,"-",this.value)},!1);a=["PlaybackColsDropdown"];for(b=0;b<a.length;b++)document.getElementById(a[b]).addEventListener("click",function(d){"BUTTON"===
d.target.nodeName&&d.target.classList.contains("material-icons")&&(d.stopPropagation(),d.preventDefault(),toggleBtnChk(d.target))},!1);document.getElementById("search").addEventListener("submit",function(){return!1},!1);document.getElementById("searchqueue").addEventListener("submit",function(){return!1},!1);document.getElementById("searchdatabase").addEventListener("submit",function(){return!1},!1);document.getElementById("searchDatabaseStr").addEventListener("keyup",function(d){if("Escape"===d.key)this.blur();
else if("Enter"===d.key&&"Album"===app.current.tag)if(""!==this.value){d=document.getElementById("searchDatabaseMatch");var g=document.createElement("button");g.classList.add("btn","btn-light","mr-2");g.setAttribute("data-filter",encodeURI(app.current.filter+" "+d.options[d.selectedIndex].value+" '"+this.value+"'"));g.innerHTML=e(app.current.filter)+" "+e(d.options[d.selectedIndex].value)+" '"+e(this.value)+'\'<span class="ml-2 badge badge-secondary">&times;</span>';this.value="";document.getElementById("searchDatabaseCrumb").appendChild(g)}else searchAlbumgrid(this.value);
else"Album"===app.current.tag?searchAlbumgrid(this.value):appGoto(app.current.app,app.current.tab,app.current.view,"0",app.current.filter,app.current.sort,app.current.tag,this.value)},!1);document.getElementById("searchDatabaseCrumb").addEventListener("click",function(d){d.preventDefault();d.stopPropagation();if("SPAN"===d.target.nodeName)d.target.parentNode.remove(),searchAlbumgrid("");else if("BUTTON"===d.target.nodeName){var g=decodeURI(d.target.getAttribute("data-filter"));document.getElementById("searchDatabaseStr").value=
g.substring(g.indexOf("'")+1,g.length-1);var k=g.substring(g.indexOf(" ")+1);k=k.substring(0,k.indexOf(" "));document.getElementById("searchDatabaseMatch").value=k;g=g.substring(0,g.indexOf(" "));selectTag("searchDatabaseTags","searchDatabaseTagsDesc",g);d.target.remove();searchAlbumgrid(document.getElementById("searchDatabaseStr").value)}},!1);domCache.searchstr.addEventListener("keyup",function(d){if("Escape"===d.key)this.blur();else if("Enter"===d.key&&settings.featAdvsearch)if(""!==this.value){d=
document.getElementById("searchMatch");var g=document.createElement("button");g.classList.add("btn","btn-light","mr-2");g.setAttribute("data-filter",encodeURI(app.current.filter+" "+d.options[d.selectedIndex].value+" '"+this.value+"'"));g.innerHTML=e(app.current.filter)+" "+e(d.options[d.selectedIndex].value)+" '"+e(this.value)+'\'<span class="ml-2 badge badge-secondary">&times;</span>';this.value="";domCache.searchCrumb.appendChild(g)}else doSearch(this.value);else doSearch(this.value)},!1);domCache.searchCrumb.addEventListener("click",
