...
function getHomeIconPictureList(a){sendAPI("MYMPD_API_HOME_ICON_PICTURE_LIST",{},function(b){for(var c='<option value="">'+t("Use ligature")+"</option>",f=0;f<b.result.returnedEntities;f++)c+='<option value="'+e(b.result.data[f])+'">'+e(b.result.data[f])+"</option>";b=document.getElementById("selectHomeIconImage");b.innerHTML=c;b.value=a})}function checkUpdate(){sendAPI("MYMPD_API_UPDATE_CHECK",{},parseUpdateCheck);btnWaiting(document.getElementById("btnCheckUpdate"),!0)}
...
dropdownLocalPlayer=new BSN.Dropdown(document.getElementById("localPlaybackMenu")),dropdownPlay=new BSN.Dropdown(document.getElementById("btnPlayDropdown")),dropdownDatabaseSort=new BSN.Dropdown(document.getElementById("btnDatabaseSortDropdown")),dropdownNeighbors=new BSN.Dropdown(document.getElementById("btnDropdownNeighbors")),collapseDBupdate=new BSN.Collapse(document.getElementById("navDBupdate")),collapseSettings=new BSN.Collapse(document.getElementById("navSettings")),collapseSyscmds=new BSN.Collapse(document.getElementById("navSyscmds")),
collapseScripting=new BSN.Collapse(document.getElementById("navScripting")),collapseJukeboxMode=new BSN.Collapse(document.getElementById("labelJukeboxMode"));
