...
function parseServers(a){var b="";if(a.error)b='<div class="list-group-item"><span class="material-icons">error_outline</span> '+t(a.error.message)+"</div>";else{for(var c=0;c<a.result.returnedEntities;c++)b+='<a href="#" class="list-group-item list-group-item-action" data-value="'+a.result.data[c].ipAddress+'">'+a.result.data[c].ipAddress+"<br/><small>"+a.result.data[c].name+"</small></a>";0===a.result.returnedEntities&&(b='<div class="list-group-item"><span class="material-icons">error_outline</span>&nbsp;'+
t("Empty list")+"</div>")}document.getElementById(!0!==settings.init?"dropdownServers1":"dropdownServers").children[0].innerHTML=b}function checkUpdate(){sendAPI("MYMPD_API_UPDATE_CHECK",{},parseUpdateCheck);btnWaiting(document.getElementById("btnCheckUpdate"),!0)}
...
"1"===a?document.getElementById("sambaVersion1").classList.remove("hide"):document.getElementById("sambaVersion1").classList.add("hide"),document.getElementById("nsCredentials1").classList.add("hide"),document.getElementById("inputNsUsername1").value="",document.getElementById("inputNsPassword1").value="")},!1),document.getElementById("btnDropdownServers1").parentNode.addEventListener("show.bs.dropdown",function(){sendAPI("MYMPD_API_NS_SERVER_LIST",{},parseServers,!0)}),document.getElementById("dropdownServers1").children[0].addEventListener("click",
function(a){a.preventDefault();"A"===a.target.nodeName&&(document.getElementById("inputNsServer1").value=a.target.getAttribute("data-value"))}),currentTab=0,showTab(currentTab),modalInit.show())}
...
document.getElementById("playDropdown").addEventListener("click",function(d){d.preventDefault();d.stopPropagation()});a=document.querySelectorAll(".dropdown-toggle");for(b=0;b<a.length;b++)a[b].parentNode.addEventListener("show.bs.dropdown",function(){alignDropdown(this)});document.getElementById("modalTimer").addEventListener("shown.bs.modal",function(){showListTimer()});document.getElementById("modalMounts").addEventListener("shown.bs.modal",function(){showListMounts()});document.getElementById("modalScripts").addEventListener("shown.bs.modal",
function(){showListScripts()});document.getElementById("modalTrigger").addEventListener("shown.bs.modal",function(){showListTrigger()});document.getElementById("modalPartitions").addEventListener("shown.bs.modal",function(){showListPartitions()});document.getElementById("modalPartitionOutputs").addEventListener("shown.bs.modal",function(){sendAPI("MPD_API_PLAYER_OUTPUT_LIST",{partition:"default"},parsePartitionOutputsList,!1)});document.getElementById("modalAbout").addEventListener("shown.bs.modal",
...
a;document.getElementById("inputHighlightColor").addEventListener("change",function(){document.getElementById("highlightColorPreview").style.backgroundColor=this.value},!1);document.getElementById("inputBgColor").addEventListener("change",function(){document.getElementById("bgColorPreview").style.backgroundColor=this.value},!1);document.getElementById("selectTheme").addEventListener("change",function(){var d=getSelectValue(this);"theme-default"===d?document.getElementById("inputBgColor").value="#ccc":
"theme-light"===d?document.getElementById("inputBgColor").value="#fff":"theme-dark"===d?document.getElementById("inputBgColor").value="#000":"theme-maroon"===d&&(document.getElementById("inputBgColor").value="#800");document.getElementById("bgColorPreview").style.backgroundColor=document.getElementById("inputBgColor").value},!1);document.getElementById("modalAddToQueue").addEventListener("shown.bs.modal",function(){document.getElementById("inputAddToQueueQuantity").classList.remove("is-invalid");
document.getElementById("warnJukeboxPlaylist2").classList.add("hide");!0===settings.featPlaylists&&sendAPI("MPD_API_PLAYLIST_LIST_ALL",{searchstr:""},function(d){getAllPlaylists(d,"selectAddToQueuePlaylist")})});document.getElementById("modalUpdateDB").addEventListener("hidden.bs.modal",function(){document.getElementById("updateDBprogress").classList.remove("updateDBprogressAnimate")});document.getElementById("modalSaveQueue").addEventListener("shown.bs.modal",function(){var d=document.getElementById("saveQueueName");
d.focus();d.value="";d.classList.remove("is-invalid")});document.getElementById("modalSettings").addEventListener("shown.bs.modal",function(){this.focus();!1===resetFlag?getSettings():resetFlag=!1;document.getElementById("inputCrossfade").classList.remove("is-invalid");document.getElementById("inputMixrampdb").classList.remove("is-invalid");document.getElementById("inputMixrampdelay").classList.remove("is-invalid");document.getElementById("inputScaleRatio").classList.remove("is-invalid")});document.getElementById("modalSettings").addEventListener("keydown",
function(d){"Enter"===d.key&&(saveSettings(!1),d.stopPropagation(),d.preventDefault())});document.getElementById("modalSettings").addEventListener("hidden.bs.modal",function(){!0===resetFlag&&modalResetSettings.show()});document.getElementById("modalResetSettings").addEventListener("hidden.bs.modal",function(){modalSettings.show()});document.getElementById("modalIdeon").addEventListener("shown.bs.modal",function(){this.focus();getSettings();document.getElementById("inputNsServer").classList.remove("is-invalid");
document.getElementById("inputNsShare").classList.remove("is-invalid");document.getElementById("inputNsUsername").classList.remove("is-invalid");document.getElementById("inputNsPassword").classList.remove("is-invalid")});document.getElementById("modalIdeon").addEventListener("keydown",function(d){"Enter"===d.key&&(saveIdeonSettings(),d.stopPropagation(),d.preventDefault())});document.getElementById("selectNsType").addEventListener("change",function(){var d=this.options[this.selectedIndex].value;"0"===
d?(document.getElementById("nsServerShare").classList.add("hide"),document.getElementById("sambaVersion").classList.add("hide"),document.getElementById("nsCredentials").classList.add("hide"),document.getElementById("inputNsServer").value="",document.getElementById("inputNsShare").value="",document.getElementById("inputNsUsername").value="",document.getElementById("inputNsPassword").value=""):"2"===d?(document.getElementById("nsServerShare").classList.remove("hide"),document.getElementById("sambaVersion").classList.remove("hide"),
document.getElementById("nsCredentials").classList.remove("hide")):(document.getElementById("nsServerShare").classList.remove("hide"),"1"===d?document.getElementById("sambaVersion").classList.remove("hide"):document.getElementById("sambaVersion").classList.add("hide"),document.getElementById("nsCredentials").classList.add("hide"),document.getElementById("inputNsUsername").value="",document.getElementById("inputNsPassword").value="")});document.getElementById("btnDropdownServers").parentNode.addEventListener("show.bs.dropdown",
function(){sendAPI("MYMPD_API_NS_SERVER_LIST",{},parseServers,!0)});document.getElementById("dropdownServers").children[0].addEventListener("click",function(d){d.preventDefault();"A"===d.target.nodeName&&(document.getElementById("inputNsServer").value=d.target.getAttribute("data-value"))});document.getElementById("modalConnection").addEventListener("shown.bs.modal",function(){getSettings();document.getElementById("inputMpdHost").classList.remove("is-invalid");document.getElementById("inputMpdPort").classList.remove("is-invalid");
document.getElementById("inputMpdPass").classList.remove("is-invalid")});document.getElementById("btnJukeboxModeGroup").addEventListener("mouseup",function(){setTimeout(function(){var d=document.getElementById("btnJukeboxModeGroup").getElementsByClassName("active")[0].getAttribute("data-value");"0"===d?(document.getElementById("inputJukeboxQueueLength").setAttribute("disabled","disabled"),document.getElementById("selectJukeboxPlaylist").setAttribute("disabled","disabled")):"2"===d?(document.getElementById("inputJukeboxQueueLength").setAttribute("disabled",
"disabled"),document.getElementById("selectJukeboxPlaylist").setAttribute("disabled","disabled"),document.getElementById("selectJukeboxPlaylist").value="Database"):"1"===d&&(document.getElementById("inputJukeboxQueueLength").removeAttribute("disabled"),document.getElementById("selectJukeboxPlaylist").removeAttribute("disabled"));"0"!==d&&toggleBtnChk("btnConsume",!0);checkConsume()},100)});document.getElementById("btnConsume").addEventListener("mouseup",function(){setTimeout(function(){checkConsume()},
