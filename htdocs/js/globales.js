...
// FIXME
uiElements.dropdownServers = BSN.Dropdown.getInstance(elGetById('btnDropdownServers'));
uiElements.dropdownServers1 = BSN.Dropdown.getInstance(elGetById('btnDropdownServers1'));
