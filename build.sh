...
installdeps() {
  ...
  then
	...
	gcc cmake perl libssl-dev libid3tag0-dev libflac-dev build-essential $JAVADEB libcurl4-gnutls-dev
  elif [ -f /etc/arch-release ]
  then
    #arch
    pacman -S gcc cmake perl openssl libid3tag flac jre-openjdk-headless curl
