...
#define MYMPD_CMDS(X) \
    ...
    X(MYMPD_API_IDEON_QOBUZ_SONG_DETAILS) \
    X(MYMPD_API_IDEON_QOBUZ_TRACK_GET_LIST) \
    X(MYMPD_API_IDEON_QOBUZ_TRACK_GET_STREAM_URL) \
    X(MYMPD_API_IDEON_QOBUZ_TRACK_SEARCH) \
    X(TOTAL_API_COUNT)
