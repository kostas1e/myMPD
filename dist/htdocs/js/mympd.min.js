...
function getHomeIconPictureList(a){sendAPI("MYMPD_API_HOME_ICON_PICTURE_LIST",{},function(b){for(var c='<option value="">'+t("Use ligature")+"</option>",f=0;f<b.result.returnedEntities;f++)c+='<option value="'+e(b.result.data[f])+'">'+e(b.result.data[f])+"</option>";b=document.getElementById("selectHomeIconImage");b.innerHTML=c;b.value=a})}function checkForUpdates(){sendAPI("MYMPD_API_CHECK_FOR_UPDATES",{},parseCheck);btnWaiting(document.getElementById("btnCheckForUpdates"),!0)}
...
!0:!1},getSettings);modalIdeon.hide()}}function confirmReset(){sendAPI("MYMPD_API_SETTINGS_RESET",{},closeReset)}function closeReset(){resetFlag=!1;modalResetSettings.hide()}var currentTab;
...
document.getElementById("addToPlaylistPlaylist").focus():(document.getElementById("streamUrl").focus(),document.getElementById("streamUrl").value="")});document.getElementById("inputTimerVolume").addEventListener("change",function(){document.getElementById("textTimerVolume").innerHTML=this.value+"&nbsp;%"},!1);document.getElementById("selectTimerAction").addEventListener("change",function(){selectTimerActionChange()},!1);document.getElementById("selectTriggerScript").addEventListener("change",function(){selectTriggerActionChange()},
!1);a="";for(b=0;24>b;b++)a+='<option value="'+b+'">'+zeroPad(b,2)+"</option>";document.getElementById("selectTimerHour").innerHTML=a;a="";for(b=0;60>b;b+=5)a+='<option value="'+b+'">'+zeroPad(b,2)+"</option>";document.getElementById("selectTimerMinute").innerHTML=a;document.getElementById("inputHighlightColor").addEventListener("change",function(){document.getElementById("highlightColorPreview").style.backgroundColor=this.value},!1);document.getElementById("inputBgColor").addEventListener("change",
function(){document.getElementById("bgColorPreview").style.backgroundColor=this.value},!1);document.getElementById("selectTheme").addEventListener("change",function(){var d=getSelectValue(this);"theme-default"===d?document.getElementById("inputBgColor").value="#ccc":"theme-light"===d?document.getElementById("inputBgColor").value="#fff":"theme-dark"===d?document.getElementById("inputBgColor").value="#000":"theme-maroon"===d&&(document.getElementById("inputBgColor").value="#800");document.getElementById("bgColorPreview").style.backgroundColor=
document.getElementById("inputBgColor").value},!1);document.getElementById("modalAddToQueue").addEventListener("shown.bs.modal",function(){document.getElementById("inputAddToQueueQuantity").classList.remove("is-invalid");document.getElementById("warnJukeboxPlaylist2").classList.add("hide");!0===settings.featPlaylists&&sendAPI("MPD_API_PLAYLIST_LIST_ALL",{searchstr:""},function(d){getAllPlaylists(d,"selectAddToQueuePlaylist")})});document.getElementById("modalUpdateDB").addEventListener("hidden.bs.modal",
...
document.getElementById("col1").classList.remove("col-md-6");var c;(c=document.getElementById("col2").classList).remove.apply(c,$jscomp.arrayFromIterable(a));document.getElementById("cardQueueMini").classList.add("hide");document.getElementById("viewListDatabaseBox").style.height="";document.getElementById("viewDetailDatabaseBox").style.height=""}}
