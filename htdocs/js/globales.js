...
uiElements.modalIdeon = new BSN.Modal(document.getElementById('modalIdeon'));
uiElements.modalInit = new BSN.Modal(document.getElementById('modalInit'));
uiElements.modalResetSettings = new BSN.Modal(document.getElementById('modalResetSettings'));
