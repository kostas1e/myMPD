...
#define MYMPD_CMDS(X) \
    ...
    X(MYMPD_API_IDEON_NS_SERVER_LIST) \
    X(MYMPD_API_IDEON_UPDATE_CHECK) \
    X(MYMPD_API_IDEON_UPDATE_INSTALL) \
    X(MYMPD_API_QOBUZ_FAVORITES) \
    X(MYMPD_API_QOBUZ_ALBUM_DETAIL) \
    X(MYMPD_API_QOBUZ_LOGIN) \
    X(MYMPD_API_QOBUZ_LOGOUT) \
    X(MYMPD_API_QOBUZ_SONG_DETAILS) \
    X(MYMPD_API_QOBUZ_TRACK_GET_LIST) \
    X(MYMPD_API_QOBUZ_TRACK_GET_STREAM_URL) \
    X(MYMPD_API_QOBUZ_SEARCH) \
    X(MYMPD_API_QOBUZ_FAVORITE_IDS) \
    X(MYMPD_API_QOBUZ_FAVORITE_TOGGLE) \
    X(MYMPD_API_QOBUZ_QUEUE_REPLACE_ALBUMS) \
    X(MYMPD_API_QOBUZ_QUEUE_NEXT_FETCH) \
    X(TOTAL_API_COUNT)
