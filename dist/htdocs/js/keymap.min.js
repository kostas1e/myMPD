...
desc:"Focus table"},q:{cmd:"queueSelectedItem",options:[!0],desc:"Add item to queue"},Q:{cmd:"queueSelectedItem",options:[!1],desc:"Replace queue with item"},d:{cmd:"dequeueSelectedItem",options:[],desc:"Remove item from queue"},x:{cmd:"addSelectedItemToPlaylist",options:[],desc:"Add item to playlist"}};
