...
var CACHE="myMPD-cache-v6.2.1",subdir=self.location.pathname.replace("/sw.js","").replace(/\/$/,""),urlsToCache=[subdir+"/",subdir+"/css/combined.css",subdir+"/js/combined.js",subdir+"/assets/appicon-192.png",subdir+"/assets/appicon-512.png",subdir+"/assets/coverimage-stream.svg",subdir+"/assets/coverimage-notavailable.svg",subdir+"/assets/coverimage-loading.svg",subdir+"/assets/favicon.ico",subdir+"/assets/MaterialIcons-Regular.woff2",subdir+"/assets/logo-ideon.png"],ignoreRequests=new RegExp("("+
[subdir+"/api",subdir+"/ca.crt",subdir+"/ws",subdir+"/library/(.*)",subdir+"/albumart/(.*)"].join("(/?)|\\")+")$");self.addEventListener("install",function(a){a.waitUntil(caches.open(CACHE).then(function(a){urlsToCache.map(function(b){return a.add(b).catch(function(a){return console.log("ServiceWorker: "+String(a)+" "+b)})})}))});
